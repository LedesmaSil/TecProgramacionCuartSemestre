...
public class SistemaEstudiantesApp {
    public static void main(String[] args) {
        ...
        var consola = new Scanner(System.in); //Para leer imformacion de la consola
        //Se crea una instancia de la clase resvicio, esto lo hacemos fuera del ciclo
        var estudianteDao = new EstudianteDAO(); //Esta instacia debe hacerse una vez
        while (!salir) {
            try {
                mostrarMenu(); //Mostramos el menu
                //Este será el método ejecutar opciones que devolvera un booleano
    ...
    public static void mostrarMenu() {
        System.out.println("""
                ******* Sistema de Estudiantes *******
                ...
                5. Eliminar Estuciante
                6. Salir
                Elige un opción:
                """);
    }

    //Método para ejecutar las opciones, va a regresar un valor booleano, ya que el que
    ...
    private static boolean ejecutarOpciones(Scanner consola, EstudianteDAO estudianteDAO) {
        ...
        switch (opcion) {
            ...
            case 5 -> {//Eliminar estudiante
                ...
                var idEstudiante = Integer.parseInt(consola.nextLine());
                var estudiante = new Estudiante(idEstudiante);
                var eliminado = estudianteDAO.buscarEStudiantePorId(estudiante);
                if (eliminado)
